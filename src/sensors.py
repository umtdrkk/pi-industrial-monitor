...
def _convert_voltage(voltage_at_adc):
    # reverse the 22k/10k divider: factor 32/10 = 3.2
    real_value = round(voltage_at_adc * 3.2, 3)
    return {"value": real_value, "unit": "V"}


def _convert_current(voltage_at_adc):
    # 150Ω shunt, no extra divider
